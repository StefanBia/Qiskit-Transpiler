...
class DAG:
    ...
    def __init__(self):
        ...
        self.classical_bits: Dict[Any, List[Any]] = {}
    
    def add_node(self, node_id: Any, data: Any = None, qubits: List[Any] = None, classical_bits: List[Any] = None) -> None:
        self.nodes[node_id] = data
        self.qubits[node_id] = qubits if qubits is not None else []
        self.classical_bits[node_id] = classical_bits if classical_bits is not None else []
